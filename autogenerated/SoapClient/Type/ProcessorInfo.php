...
class ProcessorInfo implements RequestInterface
{
     ...
     * @var bool $realTime
     * @var string $pwd
     * @var string $defaultBillerId
     * @var bool $hasTxnPwd
     * @var bool $hasManualEnrollment
     * @var int $type
     * @var string $status
     * @var string $remarks
     ...
     * @var float $minAmount
     * @var float $maxAmount
     * @var bool $mustRedirect
     * @var float $surcharge
     * @var bool $hasAltRefNo
     * @var float $cost
     */
    public function __construct($procId, $shortName, $longName, $logo, $currencies, $url, $realTime, $pwd, $defaultBillerId, $hasTxnPwd, $hasManualEnrollment, $type, $status, $remarks, $dayOfWeek, $startTime, $endTime, $minAmount, $maxAmount, $mustRedirect, $surcharge, $hasAltRefNo, $cost)
    {
        $this->procId = $procId;
        ...
        $this->pwd = $pwd;
        $this->defaultBillerId = $defaultBillerId;
        $this->hasTxnPwd = $hasTxnPwd;
        $this->hasManualEnrollment = $hasManualEnrollment;
        $this->type = $type;
        $this->status = $status;
